...
| 3 | Klassificerings- och riktningskontroller | Felfallet faller ut som fel | 2026-00066 flaggar handlingstyp 6.1-1 och process 6.1 mot kodlistan, samt omkastad avsändare/mottagare mot riktningen Inkommande | `pytest`: 2026-00066 ger minst tre flaggor i kategorin | M1 M2 | **Klar, men inte inkopplad** — 2026-09-11: `KlassificeringsChecker` i `app/klassificering.py` mot den mockade kodlistan i `data/klassificering.json`. Kontrollen uppfylld: 00066 ger tre flaggor (handlingstyp, process, omkastade kontakter), 00064 och 00065 inga. Checkern står utanför `REGISTER` i `kontroller/motor.py` och returnerar dictar i stället för `Fynd`, så knappen Kvalitetsgranska visar dem ännu inte — inkopplingen hör till inkrement 4 |
