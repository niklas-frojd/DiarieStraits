...
|---|-----------|-----------|----------|----------|-------|--------|
| 1 | Skelett: ärendelista och detaljvy | Något kör och känns igen från Janus | `uvicorn app.main:app --reload` → localhost:8000 listar de tre ärendena; klick på 2026-00064 visar fälten ur Detaljer-panelen | klick: öppna alla tre · `pytest`: `/api/arenden` ger 3 ärenden | — | Ej påbörjad |
...
| 3 | Klassificerings- och riktningskontroller | Felfallet faller ut som fel | 2026-00066 flaggar handlingstyp 6.1-1 och process 6.1 mot kodlistan, samt omkastad avsändare/mottagare mot riktningen Inkommande | `pytest`: 2026-00066 ger minst tre flaggor i kategorin | M1 M2 | Ej påbörjad |
